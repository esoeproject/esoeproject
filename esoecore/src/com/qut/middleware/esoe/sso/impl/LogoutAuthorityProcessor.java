...
{	
	...
	throws MarshallerException, UnmarshallerException
	{
		...
		this.logoutResponseUnmarshaller = new UnmarshallerImpl<Response>(this.UNMAR_PKGNAMES, this.schemas, this.metadata);
			...
			if(activeDescriptors != null)
			{
				...
				while(entitiesIterator.hasNext())
				{
					...
					while (endpointIter.hasNext())
					{
						...
						String request = this.generateLogoutRequest(principal.getSAMLAuthnIdentifier(), LOGOUT_REASON, indicies);
	 ...
	 */
	private String generateLogoutRequest(String samlAuthnID, String reason, List<String> sessionIndicies) throws MarshallerException
	{
	...
	{		
		...
		this.logger.log(InsaneLogLevel.INSANE, request);

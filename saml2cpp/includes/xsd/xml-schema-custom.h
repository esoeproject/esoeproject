...
namespace xml_schema
{
	...
	class date_time: public simple_type, 
	 ...
	 */
	void operator<< (xercesc::DOMAttr& a, const date& d);
	 ...
	 */
	void operator<< (xercesc::DOMAttr& a, const date_time& dt);
	 ...
	 */ 
	boost::gregorian::date createDate(std::wstring);

...
public class SaveServicePolicyException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public SaveServicePolicyException(String message)
	{
		super(message);
	}
	 ...
	 */
	public SaveServicePolicyException(String message, Exception cause)
	{
		super(message, cause);
	}
}

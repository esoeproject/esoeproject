...
spep::MetadataImpl::MetadataImpl( spep::ReportingProcessor *reportingProcessor, std::string schemaPath, std::wstring spepIdentifier, std::wstring esoeIdentifier, std::string metadataURL, spep::KeyResolver *keyResolver, int assertionConsumerIndex, int interval )
:
_metadataMutex(),
...
void spep::MetadataImpl::init()
{
	...
	this->_thread = new MetadataThread( this->_reportingProcessor, this, this->_schemaPath, this->_interval );
...
{
	saml2::metadata::EntitiesDescriptorType::EntitiesDescriptor::iterator entitiesDescriptorIterator;
	...
	saml2::metadata::EntitiesDescriptorType::EntityDescriptor::iterator entityDescriptorIterator;
		...
		++entityDescriptorIterator )
	{
		...
		if ( this->_esoeIdentifier.compare( entityDescriptorIterator->entityID().c_str() ) == 0 )
		{
			...
			saml2::metadata::EntityDescriptorType::IDPSSODescriptor::iterator idpSSODescriptorIterator;
				...
				++idpSSODescriptorIterator )
			{
				...
				saml2::metadata::IDPSSODescriptorType::SingleSignOnService::iterator singleSignOnServiceIterator;
				...
				saml2::metadata::IDPSSODescriptorType::SingleLogoutService::iterator singleLogoutServiceIterator;
			...
			saml2::metadata::EntityDescriptorType::AttributeAuthorityDescriptor::iterator attributeAuthorityDescriptorIterator;
				...
				++attributeAuthorityDescriptorIterator )
			{
				...
				saml2::metadata::AttributeAuthorityDescriptorType::AttributeService::iterator attributeServiceIterator;
			...
			saml2::metadata::EntityDescriptorType::RoleDescriptor::iterator roleDescriptorIterator;
				...
				++roleDescriptorIterator )
			{
				...
				if( xsiTypeValue != NULL && XMLString::compareString( xsiTypeValue, expectedXSITypeValue->get() ) == 0 )
				{
					...
					middleware::lxacmlPDPSchema::LXACMLPDPDescriptorType::AuthzService::iterator authzServiceIterator;

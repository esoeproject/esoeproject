...
public class DeleteServicePolicyException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public DeleteServicePolicyException(String message)
	{
		super(message);
	}
	 ...
	 */
	public DeleteServicePolicyException(String message, Exception cause)
	{
		super(message, cause);
	}
}

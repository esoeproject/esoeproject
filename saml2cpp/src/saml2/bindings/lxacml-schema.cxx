...
namespace middleware
{
  namespace lxacmlSchema
  {
    ...
    void PolicyType::
    PolicyId (const PolicyId_type& PolicyId)
    {
      this->PolicyId_.set (PolicyId);
    }

    void PolicyType::
    PolicyId (::std::auto_ptr< PolicyId_type > PolicyId)
    {
      this->PolicyId_.set (PolicyId);
    }
    ...
    void RuleType::
    Condition (const Condition_type& Condition)
    {
      this->Condition_.set (Condition);
    }

    void RuleType::
    Condition (const Condition_optional& Condition)
    {
      this->Condition_ = Condition;
    }

    void RuleType::
    Condition (::std::auto_ptr< Condition_type > Condition)
    {
      this->Condition_.set (Condition);
    }
    ...
    void RuleType::
    RuleId (const RuleId_type& RuleId)
    {
      this->RuleId_.set (RuleId);
    }

    void RuleType::
    RuleId (::std::auto_ptr< RuleId_type > RuleId)
    {
      this->RuleId_.set (RuleId);
    }
    ...
    void RuleType::
    Effect (const Effect_type& Effect)
    {
      this->Effect_.set (Effect);
    }

    void RuleType::
    Effect (::std::auto_ptr< Effect_type > Effect)
    {
      this->Effect_.set (Effect);
    }
    ...
    void TargetType::
    Resources (const Resources_type& Resources)
    {
      this->Resources_.set (Resources);
    }

    void TargetType::
    Resources (::std::auto_ptr< Resources_type > Resources)
    {
      this->Resources_.set (Resources);
    }
    ...
    void TargetType::
    Actions (const Actions_type& Actions)
    {
      this->Actions_.set (Actions);
    }

    void TargetType::
    Actions (::std::auto_ptr< Actions_type > Actions)
    {
      this->Actions_.set (Actions);
    }
    ...
    void ResourcesType::
    Resource (const Resource_sequence& Resource)
    {
    ...
    void ConditionType::
    Expression (const Expression_type& Expression)
    {
      this->Expression_.set (Expression);
    }

    void ConditionType::
    Expression (::std::auto_ptr< Expression_type > Expression)
    {
      this->Expression_.set (Expression);
    }
    ...
    void ApplyType::
    Expression (const Expression_sequence& Expression)
    {
    ...
    void ApplyType::
    FunctionId (const FunctionId_type& FunctionId)
    {
      this->FunctionId_.set (FunctionId);
    }

    void ApplyType::
    FunctionId (::std::auto_ptr< FunctionId_type > FunctionId)
    {
      this->FunctionId_.set (FunctionId);
    }
    ...
    AttributeId (const AttributeId_type& AttributeId)
    {
      this->AttributeId_.set (AttributeId);
    }

    void AttributeDesignatorType::
    AttributeId (::std::auto_ptr< AttributeId_type > AttributeId)
    {
      this->AttributeId_.set (AttributeId);
    }
    ...
    Obligation (const Obligation_sequence& Obligation)
    {
      this->Obligation_ = Obligation;
    }
    ...
    void ObligationType::
    AttributeAssignment (const AttributeAssignment_sequence& AttributeAssignment)
    {
      this->AttributeAssignment_ = AttributeAssignment;
    }
    ...
    void ObligationType::
    ObligationId (const ObligationId_type& ObligationId)
    {
      this->ObligationId_.set (ObligationId);
    }

    void ObligationType::
    ObligationId (::std::auto_ptr< ObligationId_type > ObligationId)
    {
      this->ObligationId_.set (ObligationId);
    }
    ...
    void ObligationType::
    FulfillOn (const FulfillOn_type& FulfillOn)
    {
      this->FulfillOn_.set (FulfillOn);
    }

    void ObligationType::
    FulfillOn (::std::auto_ptr< FulfillOn_type > FulfillOn)
    {
      this->FulfillOn_.set (FulfillOn);
    }

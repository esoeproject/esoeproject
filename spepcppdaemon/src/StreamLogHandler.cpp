...
spep::daemon::StreamLogHandler::StreamLogHandler( std::ostream &out, spep::Level level )
:
_out(out),
_level( level )
{
...
void spep::daemon::StreamLogHandler::log( const std::string &name, const spep::Level level, const std::string &message )
{

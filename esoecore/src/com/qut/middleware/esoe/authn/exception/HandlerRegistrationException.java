 ...
 * 
 * Purpose: Indicates that no handlers were registered when an authentication request was made
 */
...
{
	private static final long serialVersionUID = 436987685292323061L;
	 ...
	 */
	public HandlerRegistrationException(String message, Exception cause)
	{
		super(message, cause);
	}
}

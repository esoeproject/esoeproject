...
/* STL */
 ...
 namespace saml2
 {
 	namespace authentication
 	{
		 ...
		 * address.
		 */
 		SAML2CONSTANT const std::wstring INTERNET_PROTOCOL = L"urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol";
		 ...
		 */
 		SAML2CONSTANT const std::wstring INTERNET_PROTOCOL_PASS = L"urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword";
		 ...
		 */
 		SAML2CONSTANT const std::wstring KERBEROS = L"urn:oasis:names:tc:SAML:2.0:ac:classes:Kerberos";
		 ...
		 * process.
		 */
 		SAML2CONSTANT const std::wstring MOBILE_ONE_FACTOR_UNREG = L"urn:oasis:names:tc:SAML:2.0:ac:classes:MobileOneFactorUnregistered";
		 ...
		 */
 		SAML2CONSTANT const std::wstring MOBILE_TWO_FACTOR_UNREG = L"urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorUnregistered";
		 ...
		 */
 		SAML2CONSTANT const std::wstring MOBILE_ONE_FACTOR_CONTRACT = L"urn:oasis:names:tc:SAML:2.0:ac:classes:MobileOneFactorContract";
		 ...
		 */
 		SAML2CONSTANT const std::wstring MOBILE_TWO_FACTOR_CONTRACT = L"urn:oasis:names:tc:SAML:2.0:ac:classes:MobileTwoFactorContract";
		 ...
		 */
 		SAML2CONSTANT const std::wstring PASSWORD = L"urn:oasis:names:tc:SAML:2.0:ac:classes:Password";
		 ...
		 */
 		SAML2CONSTANT const std::wstring PASSWORD_PROTECTED_TRANSPORT = L"urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport";
		 ...
		 */
 		SAML2CONSTANT const std::wstring PREVIOUS_SESSION = L"urn:oasis:names:tc:SAML:2.0:ac:classes:PreviousSession";
		 ...
		 */
 		SAML2CONSTANT const std::wstring X509 = L"urn:oasis:names:tc:SAML:2.0:ac:classes:X509";
		 ...
		 */
 		SAML2CONSTANT const std::wstring PGP = L"urn:oasis:names:tc:SAML:2.0:ac:classes:PGP";
		 ...
		 */
 		SAML2CONSTANT const std::wstring SPKI = L"urn:oasis:names:tc:SAML:2.0:ac:classes:SPKI";
		 ...
		 */
 		SAML2CONSTANT const std::wstring XMLDSIG = L"urn:oasis:names:tc:SAML:2.0:ac:classes:XMLDSig";
	
		/**
		 * The Smartcard class is identified when a principal authenticates to an authentication authority using a
		 * smartcard.
		 */
 		SAML2CONSTANT const std::wstring SMART_CARD = L"urn:oasis:names:tc:SAML:2.0:ac:classes:Smartcard";
		 ...
		 */
 		SAML2CONSTANT const std::wstring SMART_CARD_PKI = L"urn:oasis:names:tc:SAML:2.0:ac:classes:SmartcardPKI";
		 ...
		 */
 		SAML2CONSTANT const std::wstring SOFTWARE_PKI = L"urn:oasis:names:tc:SAML:2.0:ac:classes:SoftwarePKI";
		 ...
		 */
 		SAML2CONSTANT const std::wstring TELEPHONY = L"urn:oasis:names:tc:SAML:2.0:ac:classes:Telephony";
		 ...
		 */
 		SAML2CONSTANT const std::wstring NOMAD_TELEPHONY = L"urn:oasis:names:tc:SAML:2.0:ac:classes:NomadTelephony";
	
		/**
		 * This class is used to indicate that the principal authenticated via the provision of a fixed-line telephone
		 * number and a user suffix, transported via a telephony protocol such as ADSL.
		 */
 		SAML2CONSTANT const std::wstring PERSONAL_TELEPHONY = L"urn:oasis:names:tc:SAML:2.0:ac:classes:PersonalTelephony";
	
		/**
		 * Indicates that the principal authenticated via the means of the line number, a user suffix, and a password
		 * element.
		 */
 		SAML2CONSTANT const std::wstring AUTHENTICATION_TELEPHONY = L"urn:oasis:names:tc:SAML:2.0:ac:classes:AuthenticatedTelephony";
		 ...
		 */
 		SAML2CONSTANT const std::wstring SECURE_REMOTE_PASSWORD = L"urn:oasis:names:tc:SAML:2.0:ac:classes:SecureRemotePassword";
	
		/**
		 * This class indicates that the principal authenticated by means of a client certificate, secured with the SSL/TLS
		 * transport.
		 */
 		SAML2CONSTANT const std::wstring TLS_CLIENT = L"urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient";
	
		/**
		 * The TimeSyncToken class is applicable when a principal authenticates through a time synchronization token.
		 */
 		SAML2CONSTANT const std::wstring TIME_SYNC_TOKEN = L"urn:oasis:names:tc:SAML:2.0:ac:classes:TimeSyncToken";
	
		/**
		 * The Unspecified class indicates that the authentication was performed by unspecified means.
		 */
 		SAML2CONSTANT const std::wstring UNSPECIFIED = L"urn:oasis:names:tc:SAML:2.0:ac:classes:unspecified";
	}
 }

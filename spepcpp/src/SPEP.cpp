...
#include "metadata/proxy/MetadataProxy.h"
#include "metadata/impl/MetadataImpl.h"
#include "config/proxy/ConfigurationProxy.h"
#include "config/impl/ConfigurationImpl.h"
#include "pep/proxy/SessionGroupCacheProxy.h"
#include "pep/impl/SessionGroupCacheImpl.h"
#include "startup/proxy/StartupProcessorProxy.h"
#include "startup/impl/StartupProcessorImpl.h"
#include "identifier/proxy/IdentifierCacheProxy.h"
...
spep::SPEP* spep::SPEP::initializeClient( int spepDaemonPort, std::vector<spep::Handler*> handlers )
{
	...
	spep->_wsClient = new WSClient( spep->_reportingProcessor );
	...
	spep->_wsProcessor = new WSProcessor( spep->_reportingProcessor, spep->_authnProcessor, spep->_policyEnforcementProcessor );
...
void spep::SPEP::reinitializeClient()
{
	...
	this->_wsProcessor = new WSProcessor( this->_reportingProcessor, this->_authnProcessor, this->_policyEnforcementProcessor );
...
spep::SPEP* spep::SPEP::initializeServer( spep::ConfigurationReader &configurationReader, std::vector<spep::Handler*> handlers )
{
	...
	spep->_metadata = new MetadataImpl( spep->_reportingProcessor, schemaPath, spepIdentifier, esoeIdentifier, metadataURL, spep->_spepConfigData->getKeyResolver(), assertionConsumerServiceIndex, metadataInterval );

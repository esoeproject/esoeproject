...
CREATE TABLE SPEP_REGISTRATIONS_HISTORY (DESCRIPTORID VARCHAR(100) NOT NULL, NODEID VARCHAR(100) NOT NULL, IPADDRESS VARCHAR(100) NOT NULL, COMPILEDATE VARCHAR(30) NOT NULL, COMPILESYSTEM VARCHAR(512) NOT NULL, VERSION VARCHAR(100) NOT NULL, ENVIRONMENT VARCHAR(512) NOT NULL, DATE_ADDED DATE NOT NULL, PRIMARY KEY (DESCRIPTORID, IPADDRESS));

...
public class RetrieveServiceNodeException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public RetrieveServiceNodeException(String message)
	{
		super(message);
	}
	 ...
	 */
	public RetrieveServiceNodeException(String message, Exception cause)
	{
		super(message, cause);
	}
}

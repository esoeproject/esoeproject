...
public class KeystoreResolverTest 
{
	...
	public void setUp() throws Exception
	{
		...
		this.keystoreInputStream = new FileInputStream("tests" + File.separator + "testdata" + File.separator + "testkeystore.ks");
		...
		try
		{
			FileInputStream stream = new FileInputStream("tests" + File.separator + "testdata" + File.separator + "testkeystore.ks");

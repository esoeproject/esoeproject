...
public class SaveServiceContactException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public SaveServiceContactException(String message)
	{
		super(message);
	}
	 ...
	 */
	public SaveServiceContactException(String message, Exception cause)
	{
		super(message, cause);
	}
}

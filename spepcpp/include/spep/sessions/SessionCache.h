...
namespace spep
{
	...
	class SPEPEXPORT SessionCache
	{
		 ...
		 */
		virtual void getPrincipalSession(PrincipalSession& principalSession, const std::string& localSessionID) = 0;
		/**
		 ...
		 */
		virtual void getPrincipalSessionByEsoeSessionID(PrincipalSession& principalSession, const std::wstring& esoeSessionID) = 0;
		/**
		 ...
		 */
		virtual void insertPrincipalSession(const std::string& sessionID, PrincipalSession &principalSession) = 0;
		/**
		 ...
		 */ 
		virtual void terminatePrincipalSession(const std::wstring& sessionID) = 0;
		 ...
		 */
		virtual void getUnauthenticatedSession(UnauthenticatedSession &unauthenticatedSession, const std::wstring& requestID) = 0;
		/**
		 ...
		 */
		virtual void terminateUnauthenticatedSession(const std::wstring& requestID) = 0;
		/**

...
public class ServiceCryptoCreationException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public ServiceCryptoCreationException(String message)
	{
		super(message);
	}
	 ...
	 */
	public ServiceCryptoCreationException(String message, Exception cause)
	{
		super(message, cause);
	}
}

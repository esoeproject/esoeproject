...
public class CreateServicePolicyException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public CreateServicePolicyException(String message)
	{
		super(message);
	}
	 ...
	 */
	public CreateServicePolicyException(String message, Exception cause)
	{
		super(message, cause);
	}
}

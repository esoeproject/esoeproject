...
public class SaveAttributeException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public SaveAttributeException(String message)
	{
		super(message);
	}
	 ...
	 */
	public SaveAttributeException(String message, Exception cause)
	{
		super(message, cause);
	}
}

...
public class RetrieveServiceCryptoException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public RetrieveServiceCryptoException(String message)
	{
		super(message);
	}
	 ...
	 */
	public RetrieveServiceCryptoException(String message, Exception cause)
	{
		super(message, cause);
	}
}

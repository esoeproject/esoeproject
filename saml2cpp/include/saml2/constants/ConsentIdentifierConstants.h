 ...
 namespace saml2
 {
 	namespace consent
 	{
		...
		/** No claim as to principal consent is being made. */
 		SAML2CONSTANT const std::wstring UNSPECIFIED= L"urn:oasis:names:tc:SAML:2.0:consent:unspecified";
		 
		/** Indicates that a principal’s consent has been obtained by the issuer of the message. */
 		SAML2CONSTANT const std::wstring OBTAINED= L"urn:oasis:names:tc:SAML:2.0:consent:obtained";
		 ...
		 */
 		SAML2CONSTANT const std::wstring PRIOR= L"urn:oasis:names:tc:SAML:2.0:consent:prior";
		 ...
		 */
 		SAML2CONSTANT const std::wstring CURRENT_IMPLICIT= L"urn:oasis:names:tc:SAML:2.0:consent:current-implicit";
 	}
 }

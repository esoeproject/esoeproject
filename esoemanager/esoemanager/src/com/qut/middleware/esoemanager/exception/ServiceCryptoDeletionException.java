...
public class ServiceCryptoDeletionException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public ServiceCryptoDeletionException(String message)
	{
		super(message);
	}
	 ...
	 */
	public ServiceCryptoDeletionException(String message, Exception cause)
	{
		super(message, cause);
	}
}

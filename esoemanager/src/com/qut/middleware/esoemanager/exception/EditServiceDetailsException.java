 ...
 * 
 * Purpose:  Exception for service details entry
 */
package com.qut.middleware.esoemanager.exception;

public class EditServiceDetailsException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public EditServiceDetailsException(String message)
	{
		super(message);
	}
	 ...
	 */
	public EditServiceDetailsException(String message, Exception cause)
	{
		super(message, cause);
	}
}

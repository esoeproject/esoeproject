...
public class RetrieveServiceContactException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public RetrieveServiceContactException(String message)
	{
		super(message);
	}
	 ...
	 */
	public RetrieveServiceContactException(String message, Exception cause)
	{
		super(message, cause);
	}
}

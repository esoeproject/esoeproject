...
//		 create a local id generator so we dont get collisions in our response ID
		...
		Marshaller logoutResponseMarshaller = new MarshallerImpl<Response>(MAR_PKGNAMES, logoutSchemas, keyStoreResolver);
	 ...
	 * 
	 */
	private byte[] generateFailedLogoutResponse(String inResponseTo) throws Exception
	{		
		byte[] responseDocument = null;

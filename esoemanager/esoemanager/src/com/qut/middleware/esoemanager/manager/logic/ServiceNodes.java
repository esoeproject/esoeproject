...
public interface ServiceNodes
{
	...
	public void saveServiceNodeConfiguration(String serviceID, String nodeIdentifier, String nodeURL, String nodeACS, String nodeSLS, String nodeCCS) throws SaveServiceNodeException;
	
	public void createServiceNode(String serviceID, String newNodeURL, String newNodeID) throws CreateServiceNodeException;
	
	public List<ServiceNodeConfiguration> retrieveNodeConfigurations(String serviceID) throws RetrieveServiceNodeException;
}

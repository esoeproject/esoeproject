...
CREATE TABLE SERVICE_POLICIES_HISTORICAL (DESCRIPTORID VARCHAR2(512) NOT NULL, LXACMLPOLICY CLOB NOT NULL, DATE_INSERTED DATE NOT NULL, PRIMARY KEY (DESCRIPTORID, DATE_INSERTED))
COMMENT ON TABLE SERVICE_POLICIES IS 'Stores authorative reference to all policies for all services deployed in the system'
...
CREATE TABLE SPEP_REGISTRATIONS_HISTORY (DESCRIPTORID VARCHAR2(512) NOT NULL, NODEID VARCHAR2(512) NOT NULL, IPADDRESS VARCHAR2(1024) NOT NULL, COMPILEDATE VARCHAR2(30) NOT NULL, COMPILESYSTEM VARCHAR2(512) NOT NULL, VERSION VARCHAR2(100) NOT NULL, ENVIRONMENT VARCHAR2(512) NOT NULL, DATE_ADDED DATE NOT NULL, PRIMARY KEY (DESCRIPTORID, IPADDRESS))

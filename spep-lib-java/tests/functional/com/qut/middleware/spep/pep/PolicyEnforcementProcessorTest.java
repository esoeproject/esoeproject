...
public class PolicyEnforcementProcessorTest
{
	...
	public void setUp() throws Exception
	{
		...
		this.keyStoreResolver = new KeyStoreResolverImpl(new FileInputStream(System.getProperty("user.dir") + File.separator + "secure" + File.separator + "spkeystore.ks"), "esoekspass", "54f748a6c6b8a4f8", "9d600hGZQV7591nWVtNcwAtU");

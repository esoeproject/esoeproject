...
#define CONFIRMATIONMETHODCONSTANTS_H_
 ...
 namespace saml2
 {
 	namespace confirmation
 	{
		 ...
		 * namespace).
		 */
		const static std::wstring HOLDER_OF_KEY= L"urn:oasis:names:tc:SAML:2.0:cm:holder-of-key";
		 ...
		 * defined by [SAMLCore].
		 */
		const static std::wstring SENDR_VOUCHES= L"urn:oasis:names:tc:SAML:2.0:cm:sender-vouches";
		 ...
		 */
		const static std::wstring BEARER= L"urn:oasis:names:tc:SAML:2.0:cm:bearer";
	}
 }

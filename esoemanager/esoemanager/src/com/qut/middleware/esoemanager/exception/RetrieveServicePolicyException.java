...
public class RetrieveServicePolicyException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public RetrieveServicePolicyException(String message)
	{
		super(message);
	}
	 ...
	 */
	public RetrieveServicePolicyException(String message, Exception cause)
	{
		super(message, cause);
	}
}

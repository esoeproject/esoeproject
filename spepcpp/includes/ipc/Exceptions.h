...
namespace spep { namespace ipc {
	 ...
	 */
	class IPCException : std::exception
	{
	 ...
	 */
	class InvalidArchiveStateException : public IPCException
	{
		public:
	 ...
	 */
	class InvocationTargetException : public IPCException
	{
		public:
	 ...
	 */
	class SocketException : public IPCException
	{
		public:

...
public class RegisterESOEPage extends BorderPage
{
	...
	public void onInit()
	{
		...
		if (esoeBean != null)
		{
			if (this.esoeBean.getIdpEntityID() != null)
				this.esoeForm.getField(PageConstants.ESOE_IDENTIFIER).setValue((String) this.esoeBean.getIdpEntityID());

			if (this.esoeBean.getEsoeNodeURL() != null)
				this.esoeForm.getField(PageConstants.ESOE_NODE_URL).setValue((String) this.esoeBean.getEsoeNodeURL());

			this.esoeForm.getField(PageConstants.ESOE_COMMON_DOMAIN).setValue((String) this.esoeBean.getCommonDomain());
			this.esoeForm.getField(PageConstants.ESOE_SINGLE_SIGN_ON_SERVICE).setValue((String) this.esoeBean.getEsoeSingleSignOn());
			this.esoeForm.getField(PageConstants.ESOE_ATTRIBUTE_SERVICE).setValue((String) this.esoeBean.getEsoeAttributeService());
			this.esoeForm.getField(PageConstants.ESOE_LXACML_SERVICE).setValue((String) this.esoeBean.getEsoeLxacmlService());
			this.esoeForm.getField(PageConstants.ESOE_SPEP_STARTUP_SERVICE).setValue((String) this.esoeBean.getEsoeSPEPStartupService());
			this.esoeForm.getField(PageConstants.ESOE_ORGANIZATION_NAME).setValue((String) this.esoeBean.getEsoeOrganizationName());
			this.esoeForm.getField(PageConstants.ESOE_ORGANIZATION_DISPLAY_NAME).setValue((String) this.esoeBean.getEsoeOrganizationDisplayName());
			this.esoeForm.getField(PageConstants.ESOE_ORGANIZATION_URL).setValue((String) this.esoeBean.getEsoeOrganizationURL());
		}
	}
	...
	public boolean nextClick()
	{
		...
		if (this.esoeForm.isValid())
		{
			...
			this.esoeBean.setIdpEntityID(this.esoeForm.getFieldValue(PageConstants.ESOE_IDENTIFIER));
			this.esoeBean.setCommonDomain(this.esoeForm.getFieldValue(PageConstants.ESOE_COMMON_DOMAIN));
			this.esoeBean.setEsoeNodeURL(this.esoeForm.getFieldValue(PageConstants.ESOE_NODE_URL));
			this.esoeBean.setEsoeSingleSignOn(this.esoeForm.getFieldValue(PageConstants.ESOE_SINGLE_SIGN_ON_SERVICE));
			this.esoeBean.setEsoeAttributeService(this.esoeForm.getFieldValue(PageConstants.ESOE_ATTRIBUTE_SERVICE));
			this.esoeBean.setEsoeLxacmlService(this.esoeForm.getFieldValue(PageConstants.ESOE_LXACML_SERVICE));
			this.esoeBean.setEsoeSPEPStartupService(this.esoeForm.getFieldValue(PageConstants.ESOE_SPEP_STARTUP_SERVICE));
			this.esoeBean.setEsoeOrganizationName(this.esoeForm.getFieldValue(PageConstants.ESOE_ORGANIZATION_NAME));
			this.esoeBean.setEsoeOrganizationDisplayName(this.esoeForm.getFieldValue(PageConstants.ESOE_ORGANIZATION_DISPLAY_NAME));
			this.esoeBean.setEsoeOrganizationURL(this.esoeForm.getFieldValue(PageConstants.ESOE_ORGANIZATION_URL));

...
public class RetrieveAttributeException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public RetrieveAttributeException(String message)
	{
		super(message);
	}
	 ...
	 */
	public RetrieveAttributeException(String message, Exception cause)
	{
		super(message, cause);
	}
}

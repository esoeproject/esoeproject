...
namespace spep
{
    ...
    class SPEPEXPORT MetadataThread
    {
        ...
        private:
            ...
            MetadataThread *mMetadataThread;
    ...
    public:
         ...
         */
        MetadataThread(saml2::Logger *logger, MetadataImpl *metadata, const std::string& caBundle, const std::string& schemaPath, int interval, saml2::ExternalKeyResolver *extKeyResolver);
        ...
        void doGetMetadata();
        RawMetadata getRawMetadata(const std::string& metadataURL);
    ...
    private:
        ...
        */
        ...
        int mInterval;
        const EVP_MD *mHashType;
        EVP_MD_CTX mHashContext;
        std::string mCABundle;
        std::unique_ptr<saml2::Unmarshaller<saml2::metadata::EntitiesDescriptorType>> mMetadataUnmarshaller;
        bool mDie;
    };

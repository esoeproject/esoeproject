...
public class CacheUpdateFailureMonitorTest
{
	...
	public void setUp() throws Exception
	{
		...
		String MAR_PKGNAMES = LXACMLAuthzDecisionQuery.class.getPackage().getName();
		...
		KeyStoreResolver keyStoreResolver = new KeyStoreResolverImpl(new File("secure" + File.separator + "esoekeystore.ks"), "Es0EKs54P4SSPK", "esoeprimary", "Es0EKs54P4SSPK");

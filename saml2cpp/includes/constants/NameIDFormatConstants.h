...
/* STL */
 ...
 namespace saml2
 {
 	namespace nameidformat
 	{
		 ...
		 */
		const static std::wstring ENCRYPTED= L"urn:oasis:names:tc:SAML:2.0:nameid-format:encrypted";
	
		/** The interpretation of the content of the element is left to individual implementations. */
		const static std::wstring UNSPECIFIED= L"urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified";
		 ...
		 */
		const static std::wstring EMAIL_ADDRESS= L"urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress";
		 ...
		 * [RFC 2253].
		 */
		const static std::wstring X509_SUBJECT_NAME= L"urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName";
		 ...
		 */
		const static std::wstring WINDOWS_DOMAIN_QUAL_NAME= L"urn:oasis:names:tc:SAML:1.1:nameid-format:WindowsDomainQualifiedName";
		 ...
		 */
		const static std::wstring KERBEROS= L"urn:oasis:names:tc:SAML:2.0:nameid-format:kerberos";
		 ...
		 */
		const static std::wstring ENTITY= L"urn:oasis:names:tc:SAML:2.0:nameid-format:entity";
		 ...
		 */
		const static std::wstring PERSISTENT= L"urn:oasis:names:tc:SAML:2.0:nameid-format:persistent";
		 ...
		 */
		const static std::wstring TRANS= L"urn:oasis:names:tc:SAML:2.0:nameid-format:transient";
 	}
 }

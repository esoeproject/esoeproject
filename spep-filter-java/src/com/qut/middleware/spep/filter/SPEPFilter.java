...
public class SPEPFilter implements Filter
{
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain) throws IOException, ServletException
	{
			...
			for (Cookie cookie : cookies)
			{
				if(spep.getLogoutClearCookies() != null)
				{
					for (Cookie clearCookie : spep.getLogoutClearCookies())
					{
						...
						{
							//Cookie clearCookieClone = (Cookie)clearCookie.clone();
							//clearCookieClone.setMaxAge(0);
							//clearCookieClone.setSecure( true );
							...
							//clearCookies.add(clearCookieClone);
		...
		String base64RequestURI = new String(Base64.encodeBase64(requestedURI.getBytes()));

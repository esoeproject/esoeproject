...
namespace middleware
{
  namespace lxacmlSAMLProtocolSchema
  {
    ...
    void LXACMLAuthzDecisionQueryType::
    InputContextOnly (const InputContextOnly_type& InputContextOnly)
    {
      this->InputContextOnly_.set (InputContextOnly);
    }
    ...
    void LXACMLAuthzDecisionQueryType::
    ReturnContext (const ReturnContext_type& ReturnContext)
    {
      this->ReturnContext_.set (ReturnContext);
    }
...
namespace middleware
{
  namespace lxacmlSAMLProtocolSchema
  {
    ...
    : ::saml2::protocol::RequestAbstractType (),
      ...
      InputContextOnly_ (::xml_schema::flags (), this),
      ReturnContext_ (::xml_schema::flags (), this)
    {
    }
           ...
           ::xml_schema::flags f)
    {
      ...
      while (p.more_attributes ())
      {
        ...
        {
          this->InputContextOnly (InputContextOnly_traits::create (i, f, this));
          continue;
        }

        if (n.name () == L"ReturnContext" && n.namespace_ ().empty ())
        {
          this->ReturnContext (ReturnContext_traits::create (i, f, this));
          continue;
        }
      }
      ...
      if (!InputContextOnly_.present ())
      {
        this->InputContextOnly (
          InputContextOnly_traits::create (
            ::std::wstring (L"false"),
            &p.element (), f, this));
      }

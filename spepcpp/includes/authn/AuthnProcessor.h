...
namespace spep
{
	...
	class AuthnProcessor
	{
		 ...
		 */
		void logoutPrincipal( AuthnProcessorData &data );
		...
		saml2::SAMLDocument generateLogoutResponse( const std::wstring &statusCodeValue, const std::wstring &statusMessage, const std::wstring &inResponseTo = L"" );

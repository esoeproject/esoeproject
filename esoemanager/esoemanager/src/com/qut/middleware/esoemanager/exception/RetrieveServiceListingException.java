...
public class RetrieveServiceListingException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public RetrieveServiceListingException(String message)
	{
		super(message);
	}
	 ...
	 */
	public RetrieveServiceListingException(String message, Exception cause)
	{
		super(message, cause);
	}
}

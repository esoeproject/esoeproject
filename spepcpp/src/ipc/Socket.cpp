...
// This should be in Platform.cpp but there just doesn't seem to be much point in making a new file just for 1 line.
...
void spep::ipc::ClientSocket::reconnect( int retry )
{
	...
	try
	{
		_socket = spep::ipc::ClientSocket::ClientSocket::newSocket(_port);
		_engine = new Engine( _socket );

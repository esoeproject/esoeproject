...
public class PolicyActionsUI
{
	...
	public PolicyActionsUI()
	{
		...
		this.noActions = new Label("This policy is invoked regardless of action being performed");
		this.setActions = new Label("This policy is invoked when a resource is matched and one of the following actions are matched");

 ...
 */
package com.qut.middleware.esoe.sessions.identity.pipeline.impl;
...
import com.qut.middleware.esoe.sessions.identity.pipeline.ldap.impl.UserAttributeMapper;
import com.qut.middleware.esoe.sessions.identity.pipeline.ldap.impl.UserImpl;

/** */
public class LDAPHandlerImpl implements Handler
{
	...
	private Logger logger = Logger.getLogger(LDAPHandlerImpl.class.getName());
	 ...
	 */
	public LDAPHandlerImpl(LdapTemplate template, String principalAttribute, String searchBase, SessionConfigData sessionConfigData)
	{
		if (template == null)
		{

...
public class SaveServiceNodeException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public SaveServiceNodeException(String message)
	{
		super(message);
	}
	 ...
	 */
	public SaveServiceNodeException(String message, Exception cause)
	{
		super(message, cause);
	}
}

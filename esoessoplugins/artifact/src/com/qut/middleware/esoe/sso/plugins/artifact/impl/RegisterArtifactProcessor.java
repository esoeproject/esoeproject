...
public class RegisterArtifactProcessor
{
	public RegisterArtifactProcessor(WSProcessorImpl wsProcessor, ArtifactResolver artifactResolver)
	{
		wsProcessor.setArtifactResolver(artifactResolver);
	}
}

...
/** A class used to provide methods for the creation of various objects used to populate Statements used in the 
 * LXACML protocol schema.
 */
public class ProtocolTools
{
	...
	public static Obligation createObligation(String effectType) 
	{
		...
		if(effectType != null && effectType.equalsIgnoreCase(DENY))
			...
			throw new IllegalArgumentException("Blah"); //$NON-NLS-1$
	...
	/** Create a DecisionType.
	 * 
	 * @param effectType The DecisionType to create. One of PERMIT or DENY
	...
	/**
	 * @param obligations The obligations to include in the Result.
	 * @param decision The DecisionType to include in the Result.
	 * @param status The Status object to include in the Result.

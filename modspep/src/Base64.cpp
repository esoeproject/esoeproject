...
spep::apache::Base64Exception::Base64Exception( std::string message )
:
_message( message )
{
}

spep::apache::Base64Exception::~Base64Exception() throw()
{
}

const char *spep::apache::Base64Exception::what() const throw()
{
	return _message.c_str();
}

spep::apache::Base64Encoder::Base64Encoder()
:
_document(),
_closed( false ),
...
void spep::apache::Base64Encoder::push( const char *bytes, std::size_t len )
{
	if( this->_closed )
	{
...
void spep::apache::Base64Encoder::close()
{
	if( this->_closed )
	{
...
const spep::apache::Base64Document& spep::apache::Base64Encoder::getResult() const
{
	if( !this->_closed )
	{
...
spep::apache::Base64Decoder::Base64Decoder()
:
_document(),
_closed(),
...
void spep::apache::Base64Decoder::push( const char *bytes, std::size_t len )
{
...
void spep::apache::Base64Decoder::close()
{
...
const spep::apache::Base64Document& spep::apache::Base64Decoder::getResult() const
{
	return _document;
}

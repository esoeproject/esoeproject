...
public class RetrieveServiceStartupsException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public RetrieveServiceStartupsException(String message)
	{
		super(message);
	}
	 ...
	 */
	public RetrieveServiceStartupsException(String message, Exception cause)
	{
		super(message, cause);
	}
}

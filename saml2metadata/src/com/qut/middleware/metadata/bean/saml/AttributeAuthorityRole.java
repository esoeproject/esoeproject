...
public interface AttributeAuthorityRole extends SAMLRole
{
	/**
	 * @return A random attribute service endpoint that supports the given
	 *         binding, or null if none exist.
	 */
	public String getAttributeServiceEndpoint(String binding);
	
	/**
	 * @return A list of zero or more attribute service endpoints.
	 */

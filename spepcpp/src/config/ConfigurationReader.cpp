...
void spep::ConfigurationReader::setStringValue( boost::program_options::variables_map &variablesMap, std::string variableName )
{
...
void spep::ConfigurationReader::setIntegerValue( boost::program_options::variables_map &variablesMap, std::string variableName )
{
	int count = variablesMap.count( variableName );
	char buf[MESSAGE_CONFIG_BUFFER_SIZE];
...
std::vector<std::string> spep::ConfigurationReader::getMultiValue( std::string variableName ) const
{

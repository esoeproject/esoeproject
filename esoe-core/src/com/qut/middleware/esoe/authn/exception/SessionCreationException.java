 ...
 * 
 * Purpose: Indicates that an error occurred creating a session
 */
package com.qut.middleware.esoe.authn.exception;

public class SessionCreationException extends Exception
{
	private static final long serialVersionUID = 8086774338954613306L;
	 ...
	 */
	public SessionCreationException(String message, Exception cause)
	{
		super(message, cause);
	}
}

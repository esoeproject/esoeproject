...
public class CreateServiceNodeException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public CreateServiceNodeException(String message)
	{
		super(message);
	}
	 ...
	 */
	public CreateServiceNodeException(String message, Exception cause)
	{
		super(message, cause);
	}
}

 ...
 * 
 * Purpose: Exception throwwhen config file rendering fails
 */
...
public class RenderConfigException extends Exception
{
	 ...
	 */
	public RenderConfigException(String message)
	{
		super(message);
	}
	 ...
	 */
	public RenderConfigException(String message, Exception cause)
	{
		super(message, cause);
	}
}

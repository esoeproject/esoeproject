 ...
 * 
 * Purpose: Exception thrown when attempt to view service by client fails
 */
package com.qut.middleware.esoemanager.exception;

public class ViewServiceException extends Exception
{
	/**
	 ...
	 */
	public ViewServiceException(String message, Exception cause)
	{
		super(message, cause);
	}
}

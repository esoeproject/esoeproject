...
public class DeleteServiceContactException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public DeleteServiceContactException(String message)
	{
		super(message);
	}
	 ...
	 */
	public DeleteServiceContactException(String message, Exception cause)
	{
		super(message, cause);
	}
}

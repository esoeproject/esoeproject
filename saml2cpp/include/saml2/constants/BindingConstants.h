...
/* STL */
 ...
 namespace saml2
 {
 	namespace binding
 	{
		 ...
		 */
 		SAML2CONSTANT const std::wstring SOAP= L"urn:oasis:names:tc:SAML:2.0:bindings:SOAP";
		 ...
		 * 
		 */
 		SAML2CONSTANT const std::wstring PAOS= L"urn:oasis:names:tc:SAML:2.0:bindings:PAOS";
		 ...
		 * 
		 */
 		SAML2CONSTANT const std::wstring HTTP_REDIRECT= L"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect";
		 ...
		 */
 		SAML2CONSTANT const std::wstring HTTP_POST= L"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST";
		 ...
		 */
 		SAML2CONSTANT const std::wstring HTTP_ARTIFACT= L"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Artifact";
		 ...
		 */
 		SAML2CONSTANT const std::wstring URI= L"urn:oasis:names:tc:SAML:2.0:bindings:URI";
 	}
 }

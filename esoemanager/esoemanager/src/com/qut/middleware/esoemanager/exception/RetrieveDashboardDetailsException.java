...
public class RetrieveDashboardDetailsException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public RetrieveDashboardDetailsException(String message)
	{
		super(message);
	}
	 ...
	 */
	public RetrieveDashboardDetailsException(String message, Exception cause)
	{
		super(message, cause);
	}
}

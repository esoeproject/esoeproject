...
import com.qut.middleware.esoemanager.logic.impl.RegisterServiceLogicImpl;
...
public class CryptoProcessorImpl implements CryptoProcessor
{
	...
	/* (non-Javadoc)
	 * @see com.qut.middleware.esoemanager.crypto.impl.CryptoProcessor#createSigningKeyDescriptor(java.security.interfaces.RSAPublicKey, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.qut.middleware.esoemanager.crypto.impl.CryptoProcessor#generateKeyPair(int)
	 */
	...
	/* (non-Javadoc)
	 * @see com.qut.middleware.esoemanager.crypto.impl.CryptoProcessor#generateKeyStore(java.lang.String)
	 */
	public KeyStore generateKeyStore() throws CryptoException
	{
		try
		{
			...
			/* Populate all new key stores with the key data of the local resolver, generally this is for metadata purposes
			 * to ensure that all systems in the authentication network can correctly validate the signed metadata document
			 * */
	...
	/* (non-Javadoc)
	 * @see com.qut.middleware.esoemanager.crypto.impl.CryptoProcessor#addPublicKey(java.security.KeyStore, java.security.KeyPair, java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.qut.middleware.esoemanager.crypto.impl.CryptoProcessor#addKeyPair(java.security.KeyStore, java.lang.String, java.security.KeyPair, java.lang.String, java.lang.String, java.lang.String)
	 */
			...
			String keyPairPassphrase, String keyPairSubjectDN) throws CryptoException
	{
		...
		try
		{
			...
			keyStore.setKeyEntry(privateCredentials.getAlias(), keyPair.getPrivate(), keyPairPassphrase.toCharArray(),
					certChain);
	...
	/* (non-Javadoc)
	 * @see com.qut.middleware.esoemanager.crypto.impl.CryptoProcessor#generateV3Certificate(java.security.KeyPair, java.lang.String)
	 */
	public X509Certificate generateV3Certificate(KeyPair pair, String certSubjectDN) throws CryptoException
	{
		...
		/* Only for signing */
		cert
				.addExtension(X509Extensions.KeyUsage, true, new KeyUsage(KeyUsage.digitalSignature
		...
		cert.addExtension(X509Extensions.SubjectAlternativeName, false, new GeneralNames(new GeneralName(
				GeneralName.rfc822Name, this.certIssuerEmail)));

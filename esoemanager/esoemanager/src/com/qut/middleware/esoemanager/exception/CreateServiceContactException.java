...
public class CreateServiceContactException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public CreateServiceContactException(String message)
	{
		super(message);
	}
	 ...
	 */
	public CreateServiceContactException(String message, Exception cause)
	{
		super(message, cause);
	}
}

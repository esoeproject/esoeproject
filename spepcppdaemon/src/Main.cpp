...
void directLog( std::vector<saml2::Handler*> &handlers, const std::string& message )
{
	for( std::vector<saml2::Handler*>::iterator iter = handlers.begin(); iter != handlers.end(); ++iter )
	{

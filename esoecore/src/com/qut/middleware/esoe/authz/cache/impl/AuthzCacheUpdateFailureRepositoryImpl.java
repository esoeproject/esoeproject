...
public class AuthzCacheUpdateFailureRepositoryImpl implements AuthzCacheUpdateFailureRepository
{
	 ...
	 * 
	 * 
	 * @see com.qut.middleware.esoe.authz.cache.bean.AuthzCacheUpdateFailureRepository#add(com.qut.middleware.esoe.authz.cache.bean.FailedAuthzCacheUpdate)
	...
	/* (non-Javadoc)
	 * @see com.qut.middleware.esoe.authz.cache.bean.AuthzCacheUpdateFailureRepository#clearFailures()
	 */
	...
	/* (non-Javadoc)
	 * @see com.qut.middleware.esoe.authz.cache.bean.AuthzCacheUpdateFailureRepository#getFailures()
	 * 
	...
	/* (non-Javadoc)
	 * @see com.qut.middleware.esoe.authz.cache.bean.AuthzCacheUpdateFailureRepository#remove(com.qut.middleware.esoe.authz.cache.bean.FailedAuthzCacheUpdate)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.qut.middleware.esoe.authz.cache.AuthzCacheUpdateFailureRepository#getSize()
	 */
	public int getSize()
	{
		this.rwl.readLock().lock();

 ...
 * 
 * Purpose: Indicates that a failure has occurred in the plugin loading process
 */
package com.qut.middleware.esoe.plugins.exception;

/** */
public class PluginLoaderException extends Exception
{
	private static final long serialVersionUID = 2954971878841112314L;
	 ...
	 */
	public PluginLoaderException(String message, Exception cause)
	{
		super(message, cause);
	}
}

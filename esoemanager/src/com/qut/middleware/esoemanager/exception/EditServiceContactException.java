 ...
 * 
 * Purpose:  Exception for service contact edit 
 */
package com.qut.middleware.esoemanager.exception;

public class EditServiceContactException extends Exception
{
	/**
	 * Constructor where a message is specified.
	 * @param message The message explaining the exception.
	 */
	public EditServiceContactException(String message)
	{
		super(message);
	}
	 ...
	 */
	public EditServiceContactException(String message, Exception cause)
	{
		super(message, cause);
	}
}

...
/* STL */
 ...
 namespace saml2
 {
 	namespace attribute
 	{
		 ...
		 */
		const static std::wstring UNSPECIFIED = L"urn:oasis:names:tc:SAML:2.0:attrname-format:unspecified";
		 ...
		 */
		const static std::wstring URI = L"urn:oasis:names:tc:SAML:2.0:attrname-format:uri";
		 ...
		 * of this identifier.
		 */
		const static std::wstring BASIC = L"urn:oasis:names:tc:SAML:2.0:attrname-format:basic";
 	}
 }

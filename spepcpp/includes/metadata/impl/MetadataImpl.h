...
namespace spep
{
	...
	class MetadataImpl : public Metadata
	{
		...
		public:
		MetadataImpl( ReportingProcessor *reportingProcessor, std::string schemaPath, std::wstring spepIdentifier, std::wstring esoeIdentifier, std::string metadataURL, KeyResolver *keyResolver, int assertionConsumerIndex, int interval );

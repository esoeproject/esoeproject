...
public class SSOProcessorImpl extends SSOProcessorBase
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.qut.middleware.esoe.sso.impl.SSOProcessorBase#createSucessfulAuthnResponse(com.qut.middleware.esoe.sso.bean.SSOProcessorData,
	...
	{
		this.logger.info(Messages.getString("SSOProcessor.54")); //$NON-NLS-1$
